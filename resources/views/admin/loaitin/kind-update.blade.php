                ...
                <div class="row">
                    <div style="margin-left: 10%;" class="col-lg-9">
                        <div class="card">
                            ...
                            <form action="admin/kind/update/{{$kind->id}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="card-body card-block">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="name" name="name" value="<?php echo $kind['name'] ?>" class="form-control"><small class="form-text text-muted">This is a help text</small></div>
                                    </div>
