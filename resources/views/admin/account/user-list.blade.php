            ...
            <div class="animated">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="admin/users/add" type="button" class="btn btn-secondary mb-1">
                            Add User
                        </a>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <td>
                                                    <a href="admin/users/update/<?= $ls->id ?>">
                                                        <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#update">
                                                            Edit
                                                        </button>
                                                    </a>
                                                    <a href="admin/users/delete/<?= $ls->id ?>" onclick="return confirm('Bạn muốn xóa ?')">
